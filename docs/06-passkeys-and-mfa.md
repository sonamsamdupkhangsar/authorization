...
In OpenIssuer, passkeys are used as a second factor after username/password login. If a user has enrolled at least one passkey, login requires passkey verification before the OAuth flow continues.
